...
См. `docs/runbook.md`, `docs/architecture.md`, `docs/VOVAN_SAFETY_LAYER_RU.md` и smoke-checkpoint'ы `docs/smoke/tesseract_image_smoke.md`, `docs/smoke/tesseract_rus_eng_smoke.md`.
